...
def randomizeColors():
    randColor.append(random.randint(0, 255))
    randColor.append(random.randint(0, 255))
    randColor.append(random.randint(0, 255))
...
def createMap1():
    ...
    map.append(pygame.Rect(200, 150, 300, 150))
    map.append(pygame.Rect(700, 150, 300, 150))
    map.append(pygame.Rect(200, 450, 300, 150))
    map.append(pygame.Rect(700, 450, 300, 150))
